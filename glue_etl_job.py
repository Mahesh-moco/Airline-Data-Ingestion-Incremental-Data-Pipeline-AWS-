...
AirportCodesDim_node1738383311601 = glueContext.create_dynamic_frame.from_catalog(database="airlines", table_name="dev_airlines_dim_airport_codes",redshift_tmp_dir="s3://aws-all-service-intermidite-data",additional_options={"aws_iam_role": "arn:aws:iam::140090166981:role/service-role/AmazonRedshift-CommandsAccessRole-20260202T150336"}, transformation_ctx="AirportCodesDim_node1738383311601")
...
WriteInTargetRedshiftTable_node1738383964386 = glueContext.write_dynamic_frame.from_catalog(frame=SchemaChangesForArrivalDetails_node1738383884086, database="airlines", table_name="dev_airlines_daily_flights_processed", redshift_tmp_dir="s3://aws-all-service-intermidite-data",additional_options={"aws_iam_role": "arn:aws:iam::140090166981:role/service-role/AmazonRedshift-CommandsAccessRole-20260202T150336"}, transformation_ctx="WriteInTargetRedshiftTable_node1738383964386")
